...
class ProductModel(models.Model):
    ...
    name_product = models.CharField(max_length=100, blank=True, null=True, default='')
    cover_image = models.ImageField(upload_to=get_cover_image_upload_path, blank=True, null=True)
    cover_image_alt = models.CharField(max_length=32, blank=True, null=True)
    size_table_image = models.ImageField(upload_to=get_size_table_upload_path, blank=True, null=True)
    size_table_image_alt = models.CharField(max_length=32, blank=True, null=True)
    description_image = models.ImageField(upload_to=get_description_image_upload_path, blank=True, null=True)
    description_image_alt = models.CharField(max_length=32, blank=True, null=True)
