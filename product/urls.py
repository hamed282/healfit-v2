...
urlpatterns = [
    ...
    path('category/items/<int:category>/', views.CategoryItemView.as_view(), name='category_item'),
    ...
    path('subcategory/items/<int:subcategory>/', views.SubcategoryItemView.as_view(), name='subcategory_item'),
    path('subcategory/<int:subcategory_id>/', views.SubcategoryFilterView.as_view(), name='subcategory'),

    # Shop
    path('items/<str:product>/', views.ProductItemView.as_view(), name='product_item'),
