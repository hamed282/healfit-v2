...
class CombinedBlogSerializer(serializers.Serializer):
    ...
    banner = serializers.ImageField(required=False, allow_blank=True)
    banner_alt = serializers.CharField(max_length=125, required=False, allow_blank=True)
    title = serializers.CharField(max_length=250)
    title_image = serializers.ImageField(required=False, allow_blank=True)
    title_image_alt = serializers.CharField(max_length=125, required=False, allow_blank=True)
    short_description = serializers.CharField(max_length=160)
    description = serializers.CharField(required=False, allow_blank=True)
    body = serializers.CharField()
    author = serializers.CharField(max_length=64)
    role = serializers.CharField(max_length=60, required=False, allow_blank=True)
