...
class CombinedProductSerializer(serializers.Serializer):
    gender = serializers.PrimaryKeyRelatedField(queryset=ProductGenderModel.objects.all(), required=False, allow_null=True, allow_blank=True)
    product = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    name_product = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    description_image = serializers.ImageField(required=False, allow_null=True, allow_blank=True)
    description_image_alt = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    size_table_image = serializers.ImageField(required=False, allow_null=True, allow_blank=True)
    size_table_image_alt = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    cover_image = serializers.ImageField(required=False, allow_null=True, allow_blank=True)
    cover_image_alt = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    video = serializers.FileField(required=False, allow_null=True, allow_blank=True)
    price = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    percent_discount = serializers.IntegerField(required=False, allow_null=True, allow_blank=True)
    subtitle = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    application_fields = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    description = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    details = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    size_guide = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    group_id = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    priority = serializers.IntegerField(required=False, allow_null=True, allow_blank=True)
    ...
    meta_description = serializers.CharField(max_length=160, required=False, allow_null=True, allow_blank=True)
    schema_markup = serializers.CharField(required=False, allow_null=True, allow_blank=True)
